   ...
   Add New Order
     ...
     <?php    
                  ...
                  if (isset($_SESSION['CUSID'])){  
                    ...
                    echo '<button type="submit"  name="proceed" id="proceed" class="btn btn-pup pull-right">
                            Proceed And Checkout
                            <i class="fa  fa-arrow-right fa-fw"></i>
                            </button>';
                 
                   }else{
                     echo   '<a data-target="#smyModal" data-toggle="modal" class="btn btn-pup btn-sm signup pull-right" href="">
                              Proceed And Checkout
                              <i class="fa  fa-arrow-right fa-fw"></i>
                              </a>';
                  } 
